...
const CardExpensesBreakdown = () => {
    const expCard = expensesBreakdowns.map((expensesBreakdown) => (
      ...
      return (
        <Card variant="md:col-span-2" title="Expenses Breakdown" desc={<div className="lg:grid lg:grid-cols-3">{expCard}</div>}/>
      );
}
